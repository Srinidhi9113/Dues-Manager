...
BEGIN
    INSERT INTO Library (library_id, book_id, book_name, author, publication, edition)
    VALUES (p_library_id, p_book_id, p_book_name, p_author, p_publication, p_edition);
END //
...
BEGIN
    INSERT INTO Hostel (hostel_id, hostel_name, num_rooms)
    VALUES (p_hostel_id, p_hostel_name, p_num_rooms);
END //
...
CALL InsertLibrary('PESLIB21CS234', 'BOOK_001', 'Database Systems', 'John Doe', 'PublisherX', '3rd');
...
BEGIN
    ...
    IF NOT EXISTS (
        SELECT 1
        FROM Due_Laboratory
        WHERE student_id = p_studentID AND lab_id = p_labID AND equip_id = p_equipID
    ) THEN
...
BEGIN
    INSERT INTO Due_Mess (student_id, mess_id, fee, pending, due_date)
    VALUES (p_student_id, p_mess_id, p_fee, p_fee, p_due_date);
END //
...
BEGIN
    INSERT INTO Due_Hostel (student_id, hostel_id, fee, pending, due_date)
    VALUES (p_student_id, p_hostel_id, p_fee, p_fee, p_due_date);
END //
...
-- Calls to all above procedures
/*
CALL InsertDueLibrary('PES1UG21CS622', 'PESLIB21CS234', 'BOOK_001', 100, '2023-11-21');
CALL InsertDueLaboratory('PES1UG21CS622', 'PESLAB21CS123', 'EQUIP_001', 50, '2023-11-21');
CALL InsertDueMess('PES1UG21CS622', 'PESMESS21', 30, '2023-11-21');
CALL InsertDueHostel('PES1UG21CS622', 'PESHOSTEL21', 40, '2023-11-21');
