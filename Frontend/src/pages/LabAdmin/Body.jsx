...
import FinesEntry from './FinesEntry'
import EquipmentsEntry from './EquipmentsEntry'

export default function Body() {
    const [tab,setTab] = useState("Home")
    const tabsList = ["Students Entry","Equipments Entry","Fines Entry"]
  return (
...

    {
      ...
      {
        tab==="Fines Entry" && <FinesEntry/>
      }
      {
        tab==="Equipments Entry" && <EquipmentsEntry/>
      }
    </div>
  )
}
